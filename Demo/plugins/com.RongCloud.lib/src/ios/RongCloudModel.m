...
+ (NSMutableArray *)RCGenerateGroupList:(NSArray *)grouplist
{
    ...
    for (int i=0; i< _count; i++) {
        ...
        NSString *_id       = _dic[@"id"];
        NSString *_name     = _dic[@"name"];
        ...
        RCGroup *group = [[RCGroup alloc]initWithGroupId:_dic[@"id"] groupName:_dic[@"name"] portraitUri:_dic[@"portraitUrl"]];
